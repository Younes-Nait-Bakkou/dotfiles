...
window_project_to_path["Arnabix:deploy"]="${session_project_to_path["Arnabix"]}/deploy"
...
window_project_to_path["Arnabix:deploy-server"]="${session_project_to_path["Arnabix"]}/deploy"
...
window_project_to_path["oui-gaz:deploy"]="${session_project_to_path["oui-gaz"]}/deploy"
...
window_project_to_path["oui-gaz:deploy-server"]="${session_project_to_path["oui-gaz"]}/deploy"
...
window_to_commands["Arnabix:deploy"]=""
...
window_to_commands["Arnabix:deploy-server"]=""
...
window_to_commands["oui-gaz:deploy"]=""
...
window_to_commands["oui-gaz:deploy-server"]=""
